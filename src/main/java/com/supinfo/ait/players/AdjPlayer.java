...
import com.supinfo.ait.hexBoards.AdjMatrix;
import com.supinfo.ait.hexBoards.Board;
import com.supinfo.ait.hexBoards.BoardData;
import com.supinfo.ait.hexBoards.GameBoard;
import com.supinfo.ait.gameMechanics.Move;
import com.supinfo.ait.hexBoards.OpenBoard;
import com.supinfo.ait.hexBoards.ScoreBoard;
...
public class AdjPlayer extends AbstractPlayer {
    ...
    public Move getMove() {
        ...
        for (int y = 0; y < size; y++) {
            for (int x = 0; x < size; x++) // if empty space
            {
